...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # THINK ABOUT IT:
    #
    # When would * fail to match?  "azc"[/ab*c/]
  end
  ...
  #
  # Why? потому что всегда находят первое вхождение
  ...
  # THINK ABOUT IT:
  #
  # Explain the difference between a character class ([...]) and alternation (|). оптимизированы для разных целей
  # (.|\n) - любой символ, [.\n] - либо точка либо переход на новую стоку (точка не воспринимается, как любой символ кроме новой строки)
